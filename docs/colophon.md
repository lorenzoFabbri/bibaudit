...
can challenge. And the default test run deselects anything networked: 1,282 of
the 1,283 tests run and pass with no internet at all, and the one that does not
