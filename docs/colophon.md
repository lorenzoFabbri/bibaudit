...
implementation, the 1,582-test suite, and the adversarial review passes that
...
can challenge. And the default test run deselects anything networked: 1,581 of
the 1,582 tests run and pass with no internet at all, and the one that does not
