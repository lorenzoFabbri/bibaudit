...
can challenge. And the default test run deselects anything networked: 1,833 of
the 1,884 tests run and pass with no internet at all. A suite that needs the
