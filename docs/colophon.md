...
can challenge. And the default test run deselects anything networked: 1,352 of
the 1,353 tests run and pass with no internet at all, and the one that does not
