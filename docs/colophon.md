...
implementation, the 1,393-test suite, and the adversarial review passes that
...
can challenge. And the default test run deselects anything networked: 1,392 of
the 1,393 tests run and pass with no internet at all, and the one that does not
