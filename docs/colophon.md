...
implementation, the 1,506-test suite, and the adversarial review passes that
...
can challenge. And the default test run deselects anything networked: 1,505 of
the 1,506 tests run and pass with no internet at all, and the one that does not
