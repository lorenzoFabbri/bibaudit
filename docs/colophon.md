...
implementation, the 1,489-test suite, and the adversarial review passes that
...
can challenge. And the default test run deselects anything networked: 1,488 of
the 1,489 tests run and pass with no internet at all, and the one that does not
